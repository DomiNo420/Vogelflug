...
public class GameActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialogResume = (Button) pauseDialog.findViewById(R.id.dialogResume); // ZurueckButton
																				// im
																				// Dialog
																				// initialisieren
		dialogResume.setOnClickListener(this);

		pauseGame = (Button) findViewById(R.id.pauseGame); // PauseButton im
															// Menu
															// initialisieren
